...
<body>
			                    ...
			                    <Div class="form-group">
				                    <select class="form-control" id="type" name="type">
					                    <option>Survey Type</option>
										  <option value="http://maps2.skylerdesign.com/survey/t/parent-baseline/1/">Parent Intake</option>
										  <option value="http://maps2.skylerdesign.com/survey/t/patient-baseline/2/">Patient Intake</option>
										  <option value="http://maps2.skylerdesign.com/survey/t/parent-intake-survey/3/">Parent Follow Up</option>
										  <option value="http://maps2.skylerdesign.com/survey/t/patient-intake-survey/4/">Patient Follow Up</option>
										  <option value="http://maps2.skylerdesign.com/survey/t/test/100/">TEST</option>
									</select>
			                    </Div>
    ...
    <script>
	     ...
	     $('#btn').click(function(e) {
		    ...
		    $.post("http://maps2.skylerdesign.com/survey/list_users.php",
		    {
		        lastname: lastname,
		        dob: dob
		    },
		    function(data, status){
			    // Lookup user
			    $.getJSON('http://maps2.skylerdesign.com/survey/list_users.php?q=' + lastname + '&dob=' + dob, function(data) {
				    $foo = 0;
